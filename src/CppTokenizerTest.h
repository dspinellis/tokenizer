...
public:
	void testKeyword() {
		...
		CPPUNIT_ASSERT_EQUAL((token_type)Keyword::K_dynamic_cast, ct.get_token());
	...
	void testMEMBER_PTR_FROM_OBJECT_PTR() {
		CppTokenizer ct("->*v");
		CPPUNIT_ASSERT_EQUAL((token_type)Token::MEMBER_PTR_FROM_OBJECT_PTR, ct.get_token());
	}

	void testMEMBER_FROM_OBJECT_PTR() {
		CppTokenizer ct("->a");
		CPPUNIT_ASSERT_EQUAL((token_type)Token::MEMBER_FROM_OBJECT_PTR, ct.get_token());
	}

	void testMEMBER_PTR_FROM_OBJECT() {
		CppTokenizer ct(".*x");
		CPPUNIT_ASSERT_EQUAL((token_type)Token::MEMBER_PTR_FROM_OBJECT, ct.get_token());
	}

	void testSCOPE() {
		CppTokenizer ct("::a");
		CPPUNIT_ASSERT_EQUAL((token_type)Token::SCOPE, ct.get_token());
	}
	...
	void testCppKeyword() {
		...
		CPPUNIT_ASSERT_EQUAL((token_type)'#', ct.get_token());
		CPPUNIT_ASSERT_EQUAL((token_type)Keyword::K_include, ct.get_token());
